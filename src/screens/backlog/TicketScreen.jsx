...
import { selectSelectedAppointment, selectAppointment } from '../../store/slices/appointmentsSlice';
...
export default function TicketScreen({ route }) {
    ...
    console.log('payload ticket screen', { appointment, ticket, ticket_layout });
