...
import { selectOnGoingAppointments } from '../../../store/slices/appointmentsSlice';
import { selectTicketLayouts } from '../../../store/slices/terminalsSlice';
...
const getSubHeader = (appt) =>
    ...
    get(appt, ['custom_data', 'driver_name']) || // Atualizado para ler o custom_data
    '—';

const getDetail = (appt) =>
    get(appt, ['custom_data', 'plate']) || // Atualizado para ler o custom_data
...
export default function TicketBar({ terminalConfig }) {
    ...
    const ticket_layouts = useSelector(selectTicketLayouts);


    const navigate = (appt) => {
       // Dentro do seu seletor ou componente:
      const layout = ticket_layouts[appt.ticket.layout_ref];


        navigation.navigate('Ticket', {
            appointment: appt,
            ticket: appt.ticket.content,
            layout: layout
        });
    };
