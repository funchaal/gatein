export const activityAPICall = async (userId) => {
    return new Promise((resolve) => {
        // console.log('Requisição para API de Activity')
        setTimeout(() => {
            resolve({
                data: {
                    terminals: [
                            ...
                            appointments_layouts: [
                                {
                                    ...
                                    modal_layout: [
                                        ...
                                        { 
                                            ...
                                            fields: [
                                                { label: 'Peso Bruto', field: 'gross_weight' },
                                                { label: 'Lacre', field: 'seal_number' },
                                                { label: 'Temperatura', field: 'temp_setting' }
                                            ]
                                        },
                                        {
                                            element: 'qrcode',
                                ...
                                },
                                {
                                    ...
                                    modal_layout: [
                                        ...
                                        { 
                                            element: 'section', 
                                            title: 'Informações de Carga',
                                            fields: [
                                                { label: 'Peso', field: 'gross_weight' },
                                                { label: 'Tipo', field: 'cargo_type' }
                                            ]
                                        },
                                        // { element: 'section', title: 'Acesso' },
                                        {
